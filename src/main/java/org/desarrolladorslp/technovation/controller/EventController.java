...
public class EventController {
    ...
    @GetMapping
    public ResponseEntity<List<EventDTO>> listEvents(@PathVariable String month){

        return new ResponseEntity<>(eventService.list(Integer.parseInt(month)),HttpStatus.OK);
    }
